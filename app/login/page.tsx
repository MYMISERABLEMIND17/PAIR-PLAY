    ...
    <div className="min-h-screen flex items-center justify-center bg-dark-base relative overflow-hidden px-4">
      ...
      >
        <div className="glass-panel p-8 md:p-10 rounded-2xl border border-white/10 relative z-10 text-center">
          <div className="mb-8">
            <h1 className="font-serif text-3xl text-white mb-2 tracking-tight">Welcome to Winkd</h1>
            <p className="text-white/60 font-sans text-sm">Sign in to enter the lounge and connect with your partner.</p>
          </div>
